...
@Route(path = "/main/taskfragment")
public class TaskFragment extends BaseFragment implements WorkCardAdapter.OnItemClickListener {
    private View mView;
...
//                products.clear();
    ...
    public void onItemClick(View view, int position) {
        ARouter.getInstance().build("/main/workdetailactivity")
                .withString("taskId", products.get(position).getId())
                .navigation();
    }
}
