package com.nodream.xskj.module.main.contact.adapter;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    public ContactAdapter(Context context, List<MedicalStaffBean> data) {
...
//        });
     ...
     * @param list
     */
    public void updateList(List<MedicalStaffBean> list){
        this.mData = list;
